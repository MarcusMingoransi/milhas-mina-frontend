...
export default function AllAccorIcon({
  width = 24,
  height = 24,
  color = "black",
}) {
  return (
    ...
    >
      <path
        className="st0"
        d="M326,354.8h-76.6l-56.3-117.4c-30.7,16.7-48.3,55.4-79.5,81c-15.9,13-34.5,24.6-57.6,32.5
	...
	l-39.3-82C127,99.7,132,74.8,168.1,25.8L326,354.8z"
      ...
      <path
        className="st0"
        d="M474.6,523.6l-26.8-31.9c14.1-3.2,22.7-11.3,22.7-25.4c0-15.9-13.5-23.9-30.6-23.9h-53.5v81.2h14.2v-30.7h31.8
	l24.5,30.7H474.6z M400.6,455h39.7c9.8,0,15.6,4.6,15.6,12.3c0,7.9-6.1,13-15.6,13h-39.7V455z"
      />
      <path
        className="st0"
        d="M-96.4,442.4l-41.9,81.2h16.1l8.9-18.1h47.7l8.9,18.1h16.4l-41.9-81.2H-96.4z M-107.1,492.9l17.6-35.7
	l17.6,35.7H-107.1z"
      />
      <path
        className="st0"
        d="M34.8,453.1c13.4,0,24.4,5,30,13.9l11.5-7.7c-8-11.2-22.2-19-41.4-19c-31.1,0-49,20.3-49,42.8
	...
	S13.9,453.1,34.8,453.1"
      ...
      <path
        className="st0"
        d="M163.7,453.1c13.3,0,24.4,5,30,13.9l11.5-7.7c-8-11.2-22.2-19-41.4-19c-31.1,0-49,20.3-49,42.8
	...
	S142.8,453.1,163.7,453.1"
      ...
      <path
        className="st0"
        d="M292.6,440.3c-31.1,0-49,20.3-49,42.8c0,22.4,17.9,42.7,49,42.7c31.1,0,49-20.3,49-42.7
